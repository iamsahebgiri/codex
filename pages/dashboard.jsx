  ...
  const Sidebar = () => {
    return (
      <aside className="flex w-64 flex-col" aria-label="Sidebar">
        <div className="flex flex-grow flex-col overflow-y-auto pt-5 pb-4 px-3 bg-white lg:border-r border-gray-200 dark:bg-gray-900">
          <a
            href="./dashboard"
            className="flex items-center pl-2 mb-6"
          >
